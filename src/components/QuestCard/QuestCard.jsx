...
import DificultySelectGroup from '../Select/SelectGroup'
  ...
  return (
        ...
        <form className={css.main}>
            <div className={css.levels}>
                ...
                />
                <svg className={css.svg} version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 1024 1024">
            ...
            <div className={css.task}>
                <ul className={css.list_task}>
                    <li><input type="text" className={css.input_text} readOnly={false} value={card.title}/></li>
                    <li><input type="date" className={css.input_time} value={card.date}/></li>
                </ul>
            </div>
